# RDK3 VCNL4200 Code Example

This application is for testing the VCNL4200 connected to the I2C.

 <img src="images/rdk3_vcnl4200.jpg" style="zoom:20%;" />
...
The application checks if a VCNL4200 is connected to the I2C Arduino interface of the RDK3 board and initialises it if found. The proximity and ambient light values can be seen on KitProg3 UART port.

<img src="images/debug_output.png" style="zoom:100%;" />

### Debugging

If you successfully imported the example, the debug configurations were already prepared for use with KitProg3 or MiniProg4. Open the ModusToolbox™ perspective and find the Quick Panel. Click on the debug launch configuration and wait for the programming to complete and the debugging process to start.
